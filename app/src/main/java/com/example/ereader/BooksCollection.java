...
public class BooksCollection {
    ...
    public BookDownload get(int index,BookDownload bk){ return this.booksDownload.get(index); }


    {
        books.add(new Book(1,"Капитанская дочка", "А.С. Пушкин", "На страницах произведения Маша, дочь капитана Миронова, появляется миловидной девушкой «лет осьмнадцати». Она добрая, робкая, застенчивая, легко краснеет. Мать считает ее трусихой. Капитанская дочка глубоко порядочна, немногословна, умна и хорошо разбирается в людях. Она отказывает сватающемуся к ней Швабрину, так как видит его насквозь.", 4.5,R.drawable.monk3));
        books.add(new Book(2,"Ревизор", "Н.В. Гоголь", "«Ревизор» — комедия в пяти действиях русского писателя Николая Васильевича Гоголя. Годом написания считается 1835 год, однако окончательные правки в своё произведение Н. В. Гоголь внёс в 1842 году.", 4.2,R.drawable.monk2));
        books.add(new Book(3,"Отрочество", "Л.Н. Толстой", "Вторая повесть в псевдо-автобиографической трилогии Льва Николаевича Толстого впервые напечатана в 1854 году в журнале «Современник».", 4.8,R.drawable.monk3));
