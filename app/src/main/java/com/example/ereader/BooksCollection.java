...
public class BooksCollection {
    ...
    }
    {
        ...
        books.add(new Book(2,"Ревизор", "Н.В. Гоголь", "«Ревизор» — комедия в пяти действиях русского писателя Николая Васильевича Гоголя. Годом написания считается 1835 год, однако окончательные правки в своё произведение Н. В. Гоголь внёс в 1842 году.", 4.2));
        ...
        books.add(new Book(4,"Ася", "Н.Н. Тургенев", "Повесть Ивана Сергеевича Тургенева. Написана в 1857 году, опубликована в 1858 году в первом номере журнала «Современник».", 4.0));
        books.add(new Book(5,"Горе от ума", "А.С. Грибоедов", "Комедия в стихах Александра Сергеевича Грибоедова. Сочетает в себе элементы классицизма и новых для начала XIX века романтизма и реализма.", 3.5));
    }
}
